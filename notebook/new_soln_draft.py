...
## TODO: NEED TO CHANGE THE READIN
...
def get_stats(twitter_data, dup_sal_dict, dup_sal_map_dict, non_dup_sal_dict, MAP_TweetState_TO_DupSALDict):
    ...
    task2 = sorted(list(gcc_stats.items()), key = lambda x:x[1], reverse=True)
...
def main():
    ...
    task1, task2, tas3 = get_stats(twitter_data_small, dup_sal_dict, dup_sal_map_dict, non_dup_sal_dict, MAP_TweetState_TO_DupSALDict)
